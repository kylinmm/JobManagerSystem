    ...
    $scope.LoadBackgroundJobList = function () {
        oUtils.jqGrid({
            ...
            colModel: [
                        ...
                        { name: "Name", width: 120, index: "Name", sortable: false },
                        { name: "State", width: 65, index: "State", sortable: false, formatter: $scope.formatState },
                        { name: "JobType", width: 80, index: "JobType", sortable: false },
                        { name: "AssemblyName", width: 200, index: "AssemblyName", sortable: false },
                        { name: "ClassName", width: 200, index: "ClassName", sortable: false },
                        { name: "LastRunTime", width: GridDateTimeWidth, index: "LastRunTime", sortable: false },
                        { name: "NextRunTime", width: GridDateTimeWidth, index: "NextRunTime", sortable: false },
                        ...
                        { name: "CronExpressionDescription", width: 120, index: "CronExpressionDescription", sortable: false },
